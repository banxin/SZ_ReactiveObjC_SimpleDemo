//
//  SZSeemygoAdvanceViewController.m
...
#import "SZSeemygoAdvanceViewController.h"

#import <ReactiveObjC/ReactiveObjC.h>
#import <ReactiveObjC/RACReturnSignal.h>

@interface SZSeemygoAdvanceViewController ()
{
...
@implementation SZSeemygoAdvanceViewController

- (void)viewDidLoad
{
    [super viewDidLoad];

    self.title = @"小码哥 RAC 进阶";
}
...
- (void)testFlattenMap
{
    ...
    [[_textField.rac_textSignal flattenMap:^RACSignal *(id value) {
...
/*
 FlatternMap和Map的区别  TODO 感觉这个的说明有问题，且testFlatternMapAndMap中的代码说明不了这个区别
