//
//  SZSeemygoBasicViewController.m
...
#import "SZSeemygoBasicViewController.h"
...
@interface SZSeemygoBasicViewController ()

@property (nonatomic, strong) RACCommand *command;

@end

@implementation SZSeemygoBasicViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    
    self.title = @"小码哥 RAC 基础";
}
...
/*
 ...
 6.12 RACEvent: 把数据包装成信号事件(signal event)。它主要通过RACSignal的-materialize来使用，然并没有什么太大的作用。
 */
