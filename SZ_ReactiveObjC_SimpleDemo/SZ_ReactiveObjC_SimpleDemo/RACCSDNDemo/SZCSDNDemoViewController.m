//
//  SZCSDNDemoViewController.m
//  SZ_ReactiveObjC_SimpleDemo
//
//  Created by yanl on 2018/1/28.
//  Copyright © 2018年 yanl. All rights reserved.
//

#import "SZCSDNDemoViewController.h"

#import <ReactiveObjC/ReactiveObjC.h>
#import <ReactiveObjC/RACReturnSignal.h>

/*
 http://blog.csdn.net/u010372095/article/details/77623407
 */

@interface SZCSDNDemoViewController ()

@property (nonatomic , assign) NSInteger age ;

@end

@implementation SZCSDNDemoViewController

- (void)viewDidLoad
{
    [super viewDidLoad];

    self.title = @"CSDN Demo";
}
...
- (void (^)(void))RACSignalDome
{
    return ^{
        ...
        /*
         RACSignal : 只能订阅且只有一个订阅者subscriber，RACSignal 本身不能发送信号；在创建 RACSignal 的时候会自动创建一个 RACSubscriber 类的对象subscriber，subscriber 可以发送信号信息；
         */
        ...
        RACSignal *signal = [RACSignal createSignal:^RACDisposable * _Nullable(id<RACSubscriber>  _Nonnull subscriber) {
            ...
            // 调用该方法后会自动使用 disposableWithBlock()
...
/**
 6、RACCommand：处理事件的操作.(主线程中执行)  TODO
...
/**
 12、RACReplaySubject 的 then: 方法用法。 TODO
